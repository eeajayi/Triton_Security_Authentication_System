...
a:
    ...
    Public Sub CheckNormal()
        ...
        If trainingImages.ToArray().Length <> 0 Then
            Dim termCriterias As New MCvTermCriteria(Count, 0.01)
            Dim recognizer As New EigenObjectRecognizer(trainingImages.ToArray(), labels.ToArray(), 2500, termCriterias)
